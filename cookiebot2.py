...
class Game:
    def __init__(self):
        ...
        self.upgrades = {
            ...
            'Behavioral reframing' : DoubleUpgrade('Behavioral reframing',decillion(6.5),'Factory',450),
            'The infinity engine' : DoubleUpgrade('The infinity engine',undecillion(65),'Factory',500),
            'N-dimensional assembly lines' : DoubleUpgrade('N-dimensional assembly lines',duodecillion(650),'Factory',550),
            ...
            'Altruistic loop' : DoubleUpgrade('Altruistic loop',decillion(70),'Bank',450),
            'Diminishing tax returns' : DoubleUpgrade('Diminishing tax returns',undecillion(700),'Bank',500),
            'Cookie Points' : DoubleUpgrade('Cookie Points',tredecillion(7),'Bank',550),
            ...
            'A novel idea' : DoubleUpgrade('A novel idea',undecillion(1),'Temple',450),
            'Apparitions' : DoubleUpgrade('Apparitions',duodecillion(10),'Temple',500),
            'Negatheism' : DoubleUpgrade('Negatheism',tredecillion(100),'Temple',550),
            ...
            'Spelling bees' : DoubleUpgrade('Spelling bees',undecillion(16.5),'Wizard tower',450),
            'Wizard basements' : DoubleUpgrade('Wizard basements',duodecillion(165),'Wizard tower',500),
            'Magical realism' : DoubleUpgrade('Magical realism',quattuordecillion(1.65),'Wizard tower',550),
            ...
            'Toroid universe' : DoubleUpgrade('Toroid universe',undecillion(255),'Shipment',450),
            'Prime directive' : DoubleUpgrade('Prime directive',tredecillion(2.55),'Shipment',500),
            'Cosmic foreground radiation' : DoubleUpgrade('Cosmic foreground radiation',quattuordecillion(25.5),'Shipment',550),
            ...
            'Pokey' : Cookie('Pokey',undecillion(5),1.02,Condition('Box of brand biscuits')),
